...
export function Hero() {
  return (
    <section className="animate-fade relative h-[calc(90dvh)] w-full opacity-0">
      ...
      />
      <div className="text-primary absolute top-1/2 left-1/2 flex w-full -translate-x-1/2 -translate-y-1/2 flex-col items-center gap-6 p-4 text-center text-wrap">
